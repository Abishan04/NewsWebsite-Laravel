                        ...
                        <form action="/students" method="post">
                            ...
                            <div class="form-group form-floating">
                                <input class="form-control" name="admission_no" id="admission_no"
                                    placeholder="Enter student admission no" type="text">
                            ...
                            <div class="form-group form-floating">
                                <input class="form-control" name="telephone_no" id="telephone_no"
                                    placeholder="Enter student telephone no" type="text">
                                <label for="telephone_no">Telephone No</label>
                            </div>
                            <div class="form-group form-floating">
                                <input class="form-control" name="nic_no" id=" nic_no"
                                    placeholder="Enter student Nic No" type="text">
                            ...
                            <div class="form-group form-floating">
                               ...
                               <div class="form-group form-floating">
                                <input class="form-control" name="address" id=" address"
                                    placeholder="Enter student address" type="text">
